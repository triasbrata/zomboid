SandboxVars = {
    ...
    WaterShutModifier = 2000,
    -- Minimum=-1 Maximum=2147483647 Default=14
    ElecShutModifier = 2000,
    -- Default=Rare
    ...
    coavinsfirearms = {
        ...
        -- 4 = Rare
        LootGunParts = 3,
        ConditionLossChance = 2,
        RollConditionForParts = false,
        -- Minimum=0.10 Maximum=1.00 Default=1.00
        InitialConditionMax = 1.0,
        -- Minimum=0.10 Maximum=1.00 Default=0.70
        InitialConditionMin = 0.7,
    },
    CommonSense = {
        PryingMechanic = true,
        PryAllDoors = false,
